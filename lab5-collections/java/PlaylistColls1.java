...
public class PlaylistColls1 {
    ...
    public static void main(String[] args) {
        ...
        // // TASK 5.2(b)...
        // for(Item i : playlist1) {
        //     if(i.length_secs < 20) {
        //         shortItemLengths1.add(i.length_secs);
        //     }
        // }

        List<Item> shortItemLengths1 =  playlist1.stream() 
            .filter(e -> (e.length_secs < 20))
            .toList();
